...
**Vantagem de tipo** (decidido, tabela em `tipos.json`): fogo>planta, água>fogo, planta>água, elétrico>água — golpe com vantagem causa x1,5 ("Super efetivo!"), na contramão x0,75. **Energia (ki)** (decidido, substituindo o acúmulo por acerto): a barra COMEÇA CHEIA (100); golpe especial simples gasta 10, versão forte 60 e o **golpe supremo (tecla S)** consome tudo (Cometa Ígneo, Onda Colossal, Trovão Máximo, Fúria da Selva, Impacto Colossal — 45 de dano base, o golpe mais forte do jogo). Recarrega **segurando A** (a fera para e carrega, estilo Goku juntando ki — vulnerável enquanto isso). Movimento é SÓ nas setas (WASD saiu).
