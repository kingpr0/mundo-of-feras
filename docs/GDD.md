...
**Vantagem de tipo** (decidido, tabela em `tipos.json`): fogo>planta, água>fogo, planta>água, elétrico>água — golpe com vantagem causa x1,5 ("Super efetivo!"), na contramão x0,75. **Golpe supremo** (decidido): acertos e dano recebido enchem uma barra de energia; cheia, **E** solta o golpe máximo do tipo da fera (Cometa Ígneo, Onda Colossal, Trovão Máximo, Fúria da Selva, Impacto Colossal — ~30 de dano base, projéteis gigantes). A IA também usa. **Arenas por bioma** (decidido): o ringue veste o bioma do mapa onde o duelo começou (floresta, rochas, deserto), e biomas podem ter PERIGOS — no deserto, cactos na cerca espetam quem encosta (2 de dano + empurrão). Defesa/bloqueio: adiado. Feras alfa: descartado (evoluções cumprem esse papel).
